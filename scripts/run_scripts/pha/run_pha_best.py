...
for inst in list_to_use:
    ...
    extraparams = ' -p ' + paramfile + ' --opt_file=' + PROJ_DIR + '/data/ip_opt.csv' + ' --rounds=1'
    print(EXECUTABLE + " -i " + infile + " -o " + curr_out_dir + " --log_file=" + outinfo +  extraparams)
    os.system(EXECUTABLE + " -i " + infile + " -o " + curr_out_dir + " --log_file=" + outinfo + extraparams + " > /dev/null 2>&1") 
