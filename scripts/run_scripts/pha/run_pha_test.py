...
numAlg2Rounds = [0,1,-1]
numRaysToBeCut = [5]
cutLimit = [-100] # negative means divide the limit across splits
useSplitShare = [0]
numCutsIterBilinear = [0]
useUnitVectorsHeur = [1]
useCutVertHeur = [0,1]
useTightPointsHeur = [0,1000]
usePresolve = [0]

## Set up output and input folders
results_path = PROJ_DIR + '/results' # /instances, which we have been using in the past
                  ...
                  for numalg2 in numAlg2Rounds:
                    for actoption in phaActOptions:
                      ...
                      for inst in list_to_use:
                        ...
                        os.system(EXECUTABLE + " -i " + infile + " -o " + curr_out_dir + " --log_file=" + outinfo + " -p " + paramfile + extraparams) 
